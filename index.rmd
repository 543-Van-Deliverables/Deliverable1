...
```{r}
Glink="https://github.com/543-Van-Deliverables/Deliverable1/raw/main/"
...
b1_upper_line_out=b1_upper_line + annotate(geom = 'text',label=txtOut,y = lowerT-.05,x=-0.05,angle=0)
b1_upper_line_out
```
```{r}
b1_upper_line_out_noX=b1_upper_line_out + theme(axis.text.y = element_blank(), axis.ticks.y = element_blank(), axis.title.y = element_blank())
